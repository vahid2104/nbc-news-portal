export const articleCardStyles = {
  ...
  articleList: "flex flex-col gap-4 overflow-hidden p-4 sm:flex-row",
  ...
  description: "mb-4 line-clamp-3 text-sm leading-6 text-gray-600",

  meta: "mb-5 flex flex-wrap items-center gap-3 text-xs text-gray-500",
